...
o = pd.DataFrame(rows)
o["eligible"] = (o.enrolled_days_90 >= 60).astype(int)
...
o["lever_eligible"] = ((o.enrolled_days_31_120 >= 60) & (o.enc_date <= pd.Timestamp("2026-05-09"))).astype(int)  # 120-day window complete at the 2026-09-06 pull
...
flow = {"decision_points": len(o), "patients": int(o.person_id.nunique()), "eligible_60_enrolled_days": int(o.eligible.sum()), "eligible_pct": round(100*o.eligible.mean(), 1),
